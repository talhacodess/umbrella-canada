      ...
      <div className='sm:max-w-8xl mx-auto w-[95%] flex sm:flex-row flex-col gap-4 justify-between items-center'>
        <div>
          <h3 className='font-bold text-white flex gap-2 flex-wrap items-center text-lg sm:text-xl'> 
            ...
            {title}
            {discount && (
              <span className='text-3xl sm:text-4xl font-extrabold text-[#192133] bg-white px-3 py-1 rounded-lg shadow-md'> 
                {discount}
              </span> 
            )}
        ...
        <div>
          <Button 
            label={buttonText} 
            rIcons={defaultIcon} 
            className='bg-[#192133] hover:bg-[#192133]/90 text-white font-semibold shadow-lg hover:shadow-xl' 
          />
        </div>
      </div>
    </div>
